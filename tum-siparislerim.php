...
<head>
    ...
    <title>Tüm Siparişlerim - Ganimet Mağazası</title>
...
<body>
    <header>
        ...
        <div class="auth">
            ...
            if (isset($_SESSION['user_name'])) {
                ...
                if ($user) {
                    $profilePicture = isset($user['profile_picture']) ? $user['profile_picture'] : 'Png/user.png';
            ...
            <div class="search-container">
                <input type="search" id="search-input" placeholder="Oyun Ara..." value="" data-gtm-form-interact-field-id="0">
    ...
    <main>
        <section class="content">
            ...
            <p>Tüm siparişlerim içeriği burada olacak.</p>
        </section>
    </main>
    <footer>
